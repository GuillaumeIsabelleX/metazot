...
{window.zpIntextCitations={};window.zpIntextCitationCount=0;jQuery(".zp-Metazot-InTextBib").each(function(index,instance)
{var $instance=jQuery(instance);var mz_params={};window.zpIntextCitations["post-"+jQuery(".ZP_POSTID",$instance).text()]={};mz_params.zpItemkey=!1;if(jQuery(".ZP_ITEM_KEY",$instance).text().trim().length>0)mz_params.zpItemkey=jQuery(".ZP_ITEM_KEY",$instance).text();mz_params.zpStyle=!1;if(jQuery(".ZP_STYLE",$instance).text().trim().length>0)mz_params.zpStyle=jQuery(".ZP_STYLE",$instance).text();mz_params.zpTitle=!1;if(jQuery(".ZP_TITLE",$instance).text().trim().length>0)mz_params.zpTitle=jQuery(".ZP_TITLE",$instance).text();mz_params.zpShowImages=!1;if(jQuery(".ZP_SHOWIMAGE",$instance).text().trim().length>0)mz_params.zpShowImages=jQuery(".ZP_SHOWIMAGE",$instance).text().trim();mz_params.zpShowTags=!1;if(jQuery(".ZP_SHOWTAGS",$instance).text().trim().length>0)mz_params.zpShowTags=!0;mz_params.zpDownloadable=!1;if(jQuery(".ZP_DOWNLOADABLE",$instance).text().trim().length>0)mz_params.zpDownloadable=!0;mz_params.zpShowNotes=!1;if(jQuery(".ZP_NOTES",$instance).text().trim().length>0)mz_params.zpShowNotes=!0;mz_params.zpShowAbstracts=!1;if(jQuery(".ZP_ABSTRACT",$instance).text().trim().length>0)mz_params.zpShowAbstracts=!0;mz_params.zpCiteable=!1;if(jQuery(".ZP_CITEABLE",$instance).text().trim().length>0)mz_params.zpCiteable=!0;mz_params.zpTarget=!1;if(jQuery(".ZP_TARGET",$instance).text().trim().length>0)mz_params.zpTarget=!0;mz_params.zpURLWrap=!1;if(jQuery(".ZP_URLWRAP",$instance).text().trim().length>0)mz_params.zpURLWrap=jQuery(".ZP_URLWRAP",$instance).text();mz_params.zpHighlight=!1;if(jQuery(".ZP_HIGHLIGHT",$instance).text().trim().length>0)mz_params.zpHighlight=jQuery(".ZP_HIGHLIGHT",$instance).text();mz_get_items(0,0,$instance,mz_params,!1)})}
...
{var mz_items=jQuery.parseJSON(data);if(typeof mz_items!='undefined'&&mz_items!=null&&parseInt(mz_items)!=0&&mz_items.data.length>0)
...
mz_format_intext_citations($instance,params.zpItemkey,mz_items.data,params,update);tempItems=mz_format_intextbib($instance,mz_items,params.zpItemkey,params,update);if(update===!1)jQuery("#"+mz_items.instance+" .zp-List").append(tempItems);if(params.zpShowNotes==!0&&tempNotes.length>0)
...
else{var tempPost=$instance.attr("class");tempPost=tempPost.replace("zp-Metazot zp-Metazot-InTextBib zp-Post-","");if(jQuery("#post-"+tempPost).length>0)
...
{console.log("Metazot Error:");console.log(errorThrown)}})}
...
{var tempItemsArr={};var tempHasNum=!1;var zpPostID=jQuery(".ZP_POSTID",$instance).text();jQuery.each(mz_items.data,function(index,item)
{var tempItem="";var $item_ref=jQuery("#"+mz_items.instance+" .zp-List #zp-ID-"+jQuery(".ZP_API_USER_ID",$instance).text()+"-"+item.key);if(jQuery("#"+mz_items.instance+" .zp-List #zp-ID-"+jQuery(".ZP_API_USER_ID",$instance).text()+"-"+item.key).length>0)
...
if(/csl-left-margin/i.test(item.bib)||(jQuery("#"+mz_items.instance+" .ZP_FORCENUM").text().length>0&&jQuery("#"+mz_items.instance+" .ZP_FORCENUM").text()=="1"))
...
{var tempNum=window.zpIntextCitations["post-"+zpPostID][itemKey].num;jQuery("#"+mz_items.instance+" .zp-List .zp-Entry.zp-Num-"+(tempNum-1)).after(itemBib)})}}
